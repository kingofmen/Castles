...
typedef void (APIENTRY *_glMultiTexCoord2f) (GLenum, GLfloat, GLfloat);
...
struct GLExtensionFunctions
{
	...
	_glActiveTexture ActiveTexture;
        _glMultiTexCoord2f MultiTexCoord2f;
...
#define glMultiTexCoord2f getGLExtensionFunctions().MultiTexCoord2f
